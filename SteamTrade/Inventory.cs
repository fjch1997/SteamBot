...
namespace SteamTrade
{
    public class Inventory
    {
        ...
        public static Inventory FetchInventory(ulong steamId, string apiKey, ISteamWeb steamWeb)
        {
            int attempts = 1;
        ...
        /// <param name="steamWeb">The SteamWeb instance for this Bot</param>
        public static dynamic GetInventory(SteamID steamid, ISteamWeb steamWeb)
        {
